...
["sapere corporeo pratica anni esperienza mani",
"memoria del corpo gesti incorporati",
"pratica non trasmissibile a parole",
"non basta guardare",
"mani anni esperienza",
"gesti del corpo",
"non si impara guardando",
...
["nostalgia perdita consapevolezza riconoscimento",
"dall'infanzia alla riflessione adulta",
"da descrittivo a riflessivo",
"inizia con ricordo",
"finisce con riflessione",
"cambia tono",
"da narrativo a riflessivo",
"diventa più pensoso",
"infanzia poi adulto",
"nostalgia consapevolezza"]),
...
["memoria tradizione perdita sapere tramandato",
"cibo cultura identità perdita modernità",
"trasmissione generazioni sapere rischio scomparsa",
"entrambi parlano di cibo",
"memoria e tradizione",
"perdita culturale",
"sapere che scompare",
"testo A personale testo B scientifico",
"si completano",
...
VF("6_24",2,"morfologia","Indica se è vero (V) o falso (F) che le seguenti voci verbali siano all'indicativo.",
[{t:"'riuscì' (quarto paragrafo del testo A) è all'indicativo.",ok:true},
 {t:"'poteva' in 'non si poteva trasmettere' è al congiuntivo.",ok:false},
...
["contrasto avversativo ma bensì",
"opposizione correzione bensì",
"non... ma bensì",
"rettifica corregge",
"non era ma era",
"due punti spiegano",
"opposizione netta",
"corregge prima affermazione",
"antitesi",
"contraddice poi afferma"]),
...
[{prima:"Mia madre sperava che il pane ",dopo:" uguale a quello della nonna.",ok:0},
 {prima:"Era necessario che mia nonna ",dopo:" il pane ogni settimana.",ok:1},
 {prima:"Se mia nonna ",dopo:" ancora, le chiederei la ricetta.",ok:2}],
...
["Maller disciplina precisione Alfonso intelligenza pensiero",
"intelligenza senza direzione disciplina esecuzione",
"entrambe necessarie",
"Alfonso pensa molto",
"Maller fa con precisione",
"intelligenza e disciplina diverse",
"pensare e fare",
"astratto e concreto",
"servono entrambe",
"intelligenza senza disciplina inutile"]),
...
["inerte senza direzione obiettivo concreto trasformazione",
"pigro pensoso infine consapevole",
"comprende il suo limite",
"all'inizio passivo",
"alla fine capisce",
"cambia prende coscienza",
"da inerte a consapevole",
...
["Netflix Spotify scacchi traduzione riconoscimento facciale",
"esempi concreti rendono comprensibile il concetto astratto",
"chatbot spam esempi quotidiani",
"esempi quotidiani",
"rendono chiaro",
"lettore capisce",
"dalla vita reale",
"tre esempi",
"concreto per spiegare astratto",
"familiari al lettore"]),
...
["Una congiunzione avversativa.","La ripetizione della congiunzione causale 'perché'.","Un punto e virgola.","Una proposizione relativa."],1),
...
["soggetto sistema predicato supera oggetto capacità",
"soggetto un sistema di riconoscimento predicato supera complemento oggetto le capacità umane",
"soggetto predicato oggetto circostanziali",
"soggetto sistema",
"predicato supera",
"oggetto capacità umane",
"di gran lunga circostanziale",
"in questo campo",
...
[{t:"Il padre del narratore era andato in Germania per una borsa di studio.",ok:true},
...
["identità costruzione materiali origini non determinano",
"origini punto di partenza non destino",
"chi siamo costruito da molte esperienze non solo le origini",
"non sei solo dove sei nato",
"le origini non definiscono",
"identità si costruisce",
"esperienze diverse",
"punto di partenza",
"non è un destino",
"siamo fatti di più cose"]),
...
["choc doppio partenza ritorno trasformazione prospettiva cambia",
"il viaggio cambia il modo di vedere anche casa propria",
"non si torna uguali",
"choc andata e ritorno",
"Monaco diversa da Napoli",
"al ritorno tutto sembrava diverso",
"viaggio trasforma",
"cambia prospettiva",
"non vede più uguale",
"due choc opposti"]),
...
["tesi asimmetria potere argomenti glocalizzazione UNESCO",
"globalizzazione non neutrale potere asimmetrico",
"culture non merci potere decide",
"tesi globalizzazione è asimmetrica",
"i forti impongono",
"culture non sono merci",
"potere squilibrato",
"argomento glocalizzazione",
"argomento UNESCO",
"chi ha più potere decide"]),
...
["antitesi parallelismo da un lato dall'altro contrasto",
"struttura bipartita antitetica",
"parallelismo coordinazione avversativa",
"da un lato dall'altro",
"due parti opposte",
"parallelismo",
"struttura simmetrica",
"contrasto bipartito",
"coordinazione per antitesi",
"opposizione strutturata"]),
...
[{prima:"Era necessario che le culture ",dopo:" il tempo per elaborare i cambiamenti.",ok:0},
 {prima:"Pensai che il mondo ",dopo:" più piccolo di quanto credevo.",ok:1},
 {prima:"Se le regole fossero più eque, la globalizzazione ",dopo:" un processo più giusto.",ok:2}],
...
["rispetto sacro perdita silenzio montagna cambiamento",
"il silenzio vale più delle parole di fronte alla perdita",
"nonno guida rispetto natura perdita",
"dolore silenzioso",
"perdita del nonno",
"montagna testimone",
"silenzio più eloquente",
"rispetto e commozione",
"natura e morte",
"guardare senza parole"]),
...
["leggere segni natura odore colore forma nuvole",
"sapere tradizionale natura osservazione",
"conoscenza incorporata relazione profonda con ambiente",
"odore della pioggia",
"colore del cielo",
"forma delle nuvole",
"leggere la natura",
...
["testo A esperienza vissuta emozione testo B dati scientifici spiegazione",
"personale e scientifico si completano",
"narrazione e argomentazione stessa realtà prospettive diverse",
"testo A racconto personale",
"testo B dati scientifici",
"emozione e spiegazione",
"soggettivo e oggettivo",
"insieme più completo",
"stesso tema prospettive diverse",
"cuore e ragione"]),
...
["pausa ritmo peso silenzio brevità efficace",
"frasi brevi impatto emotivo maggiore",
"sintesi emotiva silenzio vale più delle parole",
"frasi corte",
"effetto di silenzio",
"ritmo spezzato",
"peso emotivo",
"asindeto efficace",
"brevità esprime dolore",
"pausa drammatica"]),
...
[{prima:"Era necessario che i paesi ",dopo:" le emissioni di gas serra.",ok:0},
 {prima:"Se la temperatura ",dopo:" di 2 gradi, le conseguenze sarebbero gravi.",ok:1},
 {prima:"Mio nonno sperava che il ghiacciaio non ",dopo:" così rapidamente.",ok:2}],
...
["devozione morale ideale non semplice dipendente",
"servo per scelta non obbligo feudo morale",
"servire come ideale non come mestiere",
"non servo per soldi",
"scelta morale",
"serve per amore",
"non per obbligo",
"significato nobile",
"dedizione volontaria",
"senso più alto"]),
...
VF("10_8",0,"struttura_testo","Per ognuna delle seguenti citazioni dal testo, indica se appartiene alla narrazione esterna (NE) del narratore o al pensiero/sentimento interiore di Efix (IE). Premi NE o IE.",
[{t:"'Era chiamato servo, ma era piuttosto il custode di quella casa antica'",ok:true},
 {t:"'la sua vita era stata come quelle canne che crescono lungo il fiume'",ok:false},
 {t:"'Qualcuno nel paese diceva che Efix aveva una colpa antica da espiare'",ok:true},
 {t:"'c'era un affetto vero, muto e ostinato, di quelli che non hanno bisogno di parole'",ok:true}]),
...
["capelli grigi schiena curva sguardo basso silenzioso devoto fedele",
"servo devoto colpa silenzio affetto ostinato",
"fisico consumato dal lavoro interiore profondo",
"vecchio curvo",
...
["colpa non elaborata silenzio non chiede aiuto porta peso dentro",
"Efix porta un peso senza parlarne disagio taciuto",
"silenzio patologico vs normalizzare aiuto",
"non parla del dolore",
"non chiede aiuto",
"porta il peso da solo",
"colpa taciuta",
"non elabora",
"isolarsi nel silenzio",
"chiedere aiuto normale"]),
...
["soggetto Efix predicato guardava modi con gli occhi non per diritto ma per devozione",
"complementi di modo con gli occhi per devozione",
"Efix guardava con gli occhi di chi per devozione",
"soggetto Efix",
"predicato guardava",
"complemento di modo",
...
[{prima:"Era necessario che Efix ",dopo:" sempre per le signorine.",ok:0},
 {prima:"I ragazzi speravano che lo stigma ",dopo:" con il tempo.",ok:1},
 {prima:"Se Efix ",dopo:" parlato della sua colpa, forse si sarebbe sentito più libero.",ok:2}],
