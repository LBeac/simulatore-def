...
["memoria vendetta ricordo rabbia repressa","non dimentica chi lo maltratta","rabbia silenziosa"]),
...
["lavoro minorile sfruttamento cava violenza","ambiente brutale povero sfruttato","miseria ingiustizia sociale"]),
...
["circolo vizioso povertà","crisi pandemia inversione tendenza","cause intrecciate complesse"]),
...
VF("1_27",2,"morfologia","Per ognuna delle seguenti voci verbali, indica se è all'indicativo (I) o al congiuntivo (C).",
...
["principale: Malpelo si ostinò comparativa ipotetica congiuntivo","comparativa modale ipotetica","come se congiuntivo trapassato"]),

COMP("1_31",2,"morfologia","Completa le frasi con la forma corretta del verbo indicato tra parentesi.",
[{prima:"Malpelo sperava che suo padre non ",dopo:" mai. (morire – congiuntivo trapassato)",ok:0},
 {prima:"Se Malpelo ",dopo:" aiuto, la sua vita sarebbe stata diversa. (chiedere – congiuntivo imperfetto)",ok:1},
 {prima:"Era necessario che i ragazzi ",dopo:" a lavorare. (andare – congiuntivo imperfetto)",ok:2}],
...
["identità vuoto solitudine senso senza radici","libertà senza identità significato","libertà assoluta alienazione"]),
...
VF("2_8",0,"struttura_testo","Per ognuna delle seguenti frasi tratte dal testo, indica se esprime una certezza (C) o un dubbio/paradosso (D) del protagonista.",
...
["identità perduta nome riconoscimento","uomo senza radici contemporaneo","libertà senza significato identità crisi"]),
...
["furto qualcuno impersona cancellazione scomparsa profilo","furto identità rubata cancellazione eliminata","opposti furto cancellazione"]),
...
["principale capii subordinata oggettiva completiva","capii principale che libertà subordinata","subordinata oggettiva completiva"]),
...
["preoccupato attesa ansioso passeggiava fronte mano","inquieto teso aspettava silenzio","angoscia attesa soldati fuochi"]),
...
VF("3_8",0,"struttura_testo","Indica se le seguenti descrizioni si riferiscono al tamburino (T) o al colonnello (C) – rispondi indicando V se l'affermazione è corretta, F se è sbagliata.",
...
["umiltà senso del dovere modestia","non cerca gloria dovere","riservatezza virtù"]),
...
["istruzione scuola bambini diritto formazione","accesso istruzione bambini poveri","scuola fondamentale crescita"]),
...
VF("3_24",2,"morfologia","Indica per ognuna delle seguenti parole se si tratta di un nome (N), un aggettivo (A) o un avverbio (Av).",
...
["Asindeto.","Polisindeto (congiunzione 'e' ripetuta).","Coordinazione con 'oppure'.","Subordinazione."],1),
...
["due proposizioni coordinate principali","principale uscì coordinata si reggeva","due principali coordinate"]),
...
[{prima:"Quando il tamburino tornò, il colonnello capì che ",dopo:" tutto. (vedere)",ok:0},
 {prima:"Il reggimento ",dopo:" a lungo prima di accamparsi. (marciare)",ok:1},
 {prima:"Il padre del tamburino ",dopo:" in battaglia prima che il ragazzo partisse. (morire)",ok:2}],
...
["conservare preservare memoria perdita","tenere al sicuro ricordi preziosi","non per lei per sé"]),
...
VF("4_8",0,"struttura_testo","Indica se le seguenti descrizioni corrispondono all'inizio, allo sviluppo o alla conclusione del testo.",
[{t:"Sofia compra il quaderno azzurro e comincia a fare domande alla nonna. (è lo sviluppo)",ok:true},
 {t:"La nonna non riconosce più Sofia. (è la conclusione)",ok:true},
 {t:"La nonna comincia a dimenticare le cose piccole. (è l'inizio)",ok:true},
 {t:"Sofia capisce perché tiene il quaderno. (è l'inizio)",ok:false}]),
...
["sensibile premurosa amore cura discreta","agisce in silenzio amore","generosa attenta nonna"]),
...
["definizione tipi processi malattia prevenzione","da generale a specifico memoria tipi Alzheimer","struttura espositiva progressiva"]),
...
["principale era per tenerli apposizione quei ricordi comparativa come si tengono","apposizione quei ricordi comparativa come oggetti preziosi","principale comparativa apposizione"]),
...
[{prima:"La nonna ",dopo:" Sofia ogni volta che la vedeva. (riconoscere – indicativo imperfetto)",ok:0},
 {prima:"Sofia sperava che la nonna ",dopo:" i ricordi del passato. (ricordare – congiuntivo imperfetto)",ok:1},
 {prima:"Se la nonna ",dopo:" il quaderno, avrebbe pianto. (vedere – congiuntivo imperfetto)",ok:2}],
...
`Don Lollò Zirafa aveva una campagna che quell'anno, Dio sia lodato, aveva dato un'ottima produzione d'olive. L'oliveto era ricchissimo, e siccome anche l'anno avanti le olive erano state abbondanti, e il deposito di due grandi giare di creta murate, ch'egli aveva in cantina, non era bastato, ne aveva ordinate altre due più capienti da un certo Lollo di Mosca, abilissimo conciatore di terraglie.
Le giare arrivarono. Ma la più grande delle due, nella prima notte stessa, si trovò spaccata in due metà nette. Come? Nessuno lo sapeva.
...
Don Lollò non si chetò per questo, e mandò a prendere zì Dima Licasi, il più celebre conciatore di terraglie di tutta la contrada: un vecchietto torto e bitorzoluto, con le giunture delle dita grosse e nodose come nocchi di vecchia vite, in perenne conflitto con le sue terraglie, perché non trovava mai un mastice abbastanza tenace da fare da colla per tutto. Aveva trovato però una ricetta sua propria, e ci teneva tanto, che se la portava sempre in tasca cucita in un sacchetto di pelle insieme con l'atto di nascita, come se l'una e l'altro fossero ugualmente importanti per lui.
Zì Dima si presentò con gli attrezzi dell'arte e propose a don Lollò di aggiustar la giara alla sua maniera, che doveva reggere anche a chi ci battesse su un bastone. Don Lollò gli rispose che doveva voler dire, se il mastice era buono, che la giara si potrebbe vendere anche come intera.
...
Don Lollò, avvertito dal rumore, accorse alla cantina e trovò il vecchio prigioniero. – Sei entrato da solo, – gridò don Lollò, – e solo devi uscire!
– Ma come? – rispose zì Dima. – Ho aggiustato la giara dall'interno, e ora non ci passo.
– Rompila! – gridò don Lollò.
– Non posso, – rispose zì Dima. – Il mastice tiene benissimo.
...
"Luigi Pirandello, Novelle per un anno (1909) – opera in pubblico dominio"),
...
["Don Lollò che non riesce a vendere le olive.",
 ...
 "Il conflitto tra don Lollò e il primo conciatore."],1),

SM("5_2",0,"comprensione_locale","Perché don Lollò aveva bisogno di nuove giare?",
["Le vecchie erano rotte da anni.",
 "Voleva ampliare la cantina con giare più ornamentali.",
 "La produzione di olive era abbondante e le giare esistenti non bastavano.",
 "Il conciatore gliele aveva offerte a prezzo basso."],2),
...
[{t:"La giara si rompe perché qualcuno la spacca intenzionalmente.",ok:false},
 {t:"Zì Dima porta sempre con sé la sua ricetta segreta del mastice.",ok:true},
 {t:"Don Lollò è soddisfatto del lavoro di zì Dima.",ok:true},
...
["Perché la giara è di valore storico e non può essere toccata.",
 "Rompendola perderebbe il valore della riparazione; tenendo il vecchio dentro violerebbe la legge.",
 "Perché zì Dima gli ha detto che il mastice non reggerebbe la rottura.",
 "Perché don Lollò ha paura di zì Dima."],1),
...
["regole rigide situazioni assurde paradosso vita","contratti proprietà assurdo","legge formale vs situazione reale"]),

SM("5_6",0,"struttura_testo","Il testo usa la tecnica del paradosso comico: una situazione inizialmente normale che diventa assurda. Quale frase segna il momento in cui la storia cambia registro?",
["'Don Lollò Zirafa aveva una campagna...'",
 "'Le giare arrivarono.'",
 "'Ma ecco che nel tirarsi su per uscire, zì Dima s'accorse di non poter uscire dalla giara.'",
 "'Il mastice tiene benissimo.'"],2),

SM("5_7",0,"lessico_contesto","'Bitorzoluto' (quarto paragrafo) descrive:",
["Una persona molto anziana e stanca.",
 "Una superficie o un corpo con molti nodi e protuberanze irregolari.",
 "Qualcuno di particolarmente abile nel suo mestiere.",
 "Una persona irascibile e scontrosa."],1),

VF("5_8",0,"struttura_testo","Indica se le seguenti caratteristiche appartengono a don Lollò (D), a zì Dima (Z) o a entrambi (E).",
[{t:"È arrabbiato con il primo conciatore. (don Lollò)",ok:true},
 {t:"Ha una sua ricetta segreta del mastice. (zì Dima)",ok:true},
 {t:"Vorrebbe risolvere il problema senza perdere denaro. (don Lollò)",ok:true},
 {t:"Si trova in una situazione paradossale. (entrambi)",ok:true}]),
...
["avaro tirchio attaccato denaro irascibile","arrabbiato giara denaro rabbioso","possessivo beni economici arrabbiato"]),
...
["Un tipo di oliva particolare.",
 ...
 "Un attrezzo da lavoro del conciatore.",
 "Un tipo di argilla per fare le giare."],1),

T("5_t2",0,"Testo B – Il linguaggio del cinema",
`Il cinema è un linguaggio. Come ogni linguaggio, ha una grammatica, cioè un insieme di regole e convenzioni che i registi usano per raccontare storie e comunicare emozioni. Imparare a 'leggere' un film significa capire come funzionano questi elementi.
L'inquadratura è l'unità di base del cinema: è ciò che la macchina da presa vede in un determinato momento. La sua grandezza cambia significato: un campo lungo, che mostra un paesaggio intero con i personaggi piccoli in lontananza, comunica solitudine o grandiosità; un primo piano, che riempie lo schermo con il volto di un personaggio, comunica emozione intensa e intimità; un dettaglio, che isola un oggetto o una parte del corpo, attira l'attenzione su qualcosa di importante.
Il montaggio è il modo in cui le inquadrature vengono collegate tra loro. Un montaggio veloce, con molti tagli ravvicinati, crea tensione e agitazione; un montaggio lento, con inquadrature lunghe, comunica calma o malinconia. Il regista russo Lev Kulešov dimostrò all'inizio del Novecento che lo stesso volto di un attore sembrava esprimere emozioni diverse a seconda dell'inquadratura che gli veniva accostata: fame se dopo di lui compariva un piatto di cibo, dolore se compariva un cadavere, gioia se compariva una bambina che giocava.
La musica e il sonoro amplificano il significato visivo: una scena felice con musica in minore diventa immediatamente inquietante. I colori e la luce hanno la stessa funzione: le scene romantiche tendono a usare tonalità calde e luce morbida; le scene di pericolo usano colori freddi e luci dure e contrastate.
Conoscere questo linguaggio non è un esercizio da specialisti: ci rende spettatori più consapevoli, capaci di capire come veniamo guidati nelle emozioni, e più difficili da manipolare.`,
"Testo originale a fini didattici"),

SM("5_11",0,"comprensione_globale","Il testo B tratta principalmente:",
["La storia del cinema dalle origini a oggi.",
 "Gli elementi del linguaggio cinematografico e il loro significato.",
 "Come diventare registi professionisti.",
 "I film più importanti della storia del cinema."],1),

SM("5_12",0,"comprensione_locale","Cosa dimostrò l'esperimento di Kulešov?",
["Che gli attori russi erano i migliori del mondo.",
 "Che lo stesso volto assume significati diversi a seconda di cosa viene mostrato prima o dopo.",
 "Che il montaggio veloce è più efficace di quello lento.",
 "Che la musica è più importante delle immagini."],1),
...
[{t:"Un campo lungo comunica solitudine o grandiosità.",ok:true},
 {t:"Un montaggio veloce comunica calma e serenità.",ok:false},
 {t:"Il primo piano isola un oggetto o una parte del corpo.",ok:false},
 {t:"I colori freddi sono spesso associati a scene di pericolo.",ok:true},
 {t:"Kulešov lavorava in Russia all'inizio del Novecento.",ok:true}]),
...
["Perché capire come funziona la manipolazione ci permette di resistere alla pubblicità.",
 "Perché sapere come veniamo guidati nelle emozioni ci rende spettatori più critici e consapevoli.",
 "Perché i registi usano trucchi per ingannarci e dobbiamo imparare a difenderci.",
 "Perché la manipolazione cinematografica è illegale in molti paesi."],1),
...
["primo piano dettaglio giara paradosso montaggio","regia camera close up","linguaggio visivo inquadratura"]),

T("5_t3",1,"SEZIONE B – LESSICO","",""),

SM("5_16",1,"lessico","Sinonimo di 'paradosso':",
["Una situazione ovvia e logica.","Una situazione contraddittoria che sembra impossibile ma esiste.","Un errore grave di ragionamento.","Una figura retorica di tipo sonoro."],1),
...
["Il direttore della fotografia ha scelto un'inquadratura ravvicinata.",
 "Bisogna cambiare l'inquadratura della situazione per capirla meglio.",
 "L'inquadratura del primo piano esprime emozione intensa.",
 "Il regista ha deciso l'inquadratura durante le riprese."],1),

COMP("5_18",1,"lessico_contesto","Completa le frasi scegliendo la parola corretta.",
[{prima:"Il cinema è un linguaggio con una propria ",dopo:", cioè un insieme di regole.",ok:0},
 {prima:"Il montaggio ",dopo:" crea tensione e agitazione.",ok:1},
 {prima:"Conoscere il linguaggio cinematografico ci rende spettatori più ",dopo:".",ok:2}],
["grammatica","veloce","consapevoli","vocabolario","lento","ingenui"]),
...
["campo lungo","primo piano","montaggio veloce","colori freddi"],
["comunica emozione intensa e intimità","suggerisce pericolo o tensione psicologica","crea agitazione e tensione ritmica","comunica solitudine o grandiosità"],
{0:3,1:0,2:2,3:1}),

SM("5_21",1,"lessico","La parola 'perenne' (quarto paragrafo del testo A) significa:",
["Molto raro e insolito.","Continuo, che dura per sempre senza interruzione.","Antico e di valore storico.","Difficile da risolvere."],1),

SM("5_22",1,"lessico","Quale delle seguenti parole contiene un prefisso con significato 'contro/insieme'?",
["Arricchire","Contrastare","Rimodellare","Insolito"],1),
...
VF("5_24",2,"morfologia","Indica se le parole sottolineate hanno funzione di sostantivo (S), aggettivo (A) o avverbio (Av).",
[{t:"'benissimo' (nel dialogo 'il mastice tiene benissimo') è un avverbio.",ok:true},
 {t:"'intera' (nella frase 'vendere come intera') è un aggettivo.",ok:true},
 {t:"'prigioniero' (nella frase 'rimasto prigioniero') è un avverbio.",ok:false},
 {t:"'abilissimo' (nella descrizione di Lollo di Mosca) è un aggettivo al superlativo assoluto.",ok:true}]),

SM("5_25",2,"sintassi","In 'siccome anche l'anno avanti le olive erano state abbondanti', la congiunzione 'siccome' introduce:",
["Una proposizione causale.","Una proposizione concessiva.","Una proposizione temporale.","Una proposizione consecutiva."],0),
...
["principale si mordeva causale perché non sapeva finale senza perdere","principale subordinate causale finale","si mordeva principale causale perché"]),
...
["Participio passato con funzione di predicato nominale.",
 "Aggettivo qualificativo semplice.",
 "Gerundio passato.",
 "Participio presente."],0),

COMP("5_28",2,"morfologia","Trasforma le frasi dal discorso diretto al discorso indiretto.",
[{prima:"Don Lollò gridò: 'Rompila!' → Don Lollò gridò che ",dopo:".",ok:0},
 {prima:"Zì Dima rispose: 'Ho aggiustato la giara dall'interno.' → Zì Dima rispose che ",dopo:".",ok:1}],
["la rompesse","aveva aggiustato la giara dall'interno","la rompa","ha aggiustato la giara"]),

SM("5_29",2,"punteggiatura","I trattini nel dialogo finale ('– Rompila! – gridò don Lollò. – Non posso, – rispose zì Dima.') segnalano:",
["Un inciso esplicativo del narratore.",
 "Il cambio di battuta nel dialogo tra i personaggi.",
 "Un elenco di azioni.",
 "Un'interruzione improvvisa del discorso."],1),

SM("5_30",2,"coesione","In 'ci teneva tanto, che se la portava sempre in tasca', il pronome 'ci' si riferisce a:",
["Alla giara da riparare.",
 "Alla ricetta segreta del mastice.",
 "All'atto di nascita.",
 "Alla contrada dove viveva zì Dima."],1),
...
["Zì Dima riparò la giara perché il mastice era buono.",
 "Zì Dima riparò la giara sebbene sapesse di non poter uscire.",
 "Zì Dima riparò la giara per guadagnare qualcosa.",
 "Zì Dima riparò la giara quando don Lollò glielo chiese."],1),
...
["Zì Dima aveva portato con sé i suoi attrezzi.",
 ...
 "Zì Dima aveva portato con sé i suòi attrezzi.",
 "Zì Dima aveva portatto con sé i suoi attrezzi."],0),

SM("5_34",2,"morfologia","In 'come se l'una e l'altro fossero ugualmente importanti', il modo di 'fossero' è:",
["Indicativo imperfetto.","Congiuntivo imperfetto.","Condizionale presente.","Congiuntivo trapassato."],1),
